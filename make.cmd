...
echo    os2-emx      - emx/gcc 3.x compile.
...
rem This is the script that builds OS/2 dmake using IBM ICC Compiler
:mkibm
os2\ibm\icc\mk.cmd
goto end
...
:mkemx
echo Build of dmake for OS/2 using emx/gcc 3.2.x
@echo on
